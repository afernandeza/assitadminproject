...
if(nombre != null){
	success = UsersManager.insertUser(nombre, appat, apmat, rol, username, contrasena);
}
%>
<html>
<head>
...
<% if(success){ %>
	<tr>
		<td><div class="notification">Inserci&oacute;n exitosa.</div></td>
	</tr>
	<tr>
<% }  %>
	...
	<tr>
		...
		<td><input type="text" name="apellidoPa">
		  <span class="style1">*</span></td>
	</tr>
	<tr>
		<td>Apellido materno</td>
		<td><input type="text" name="apellidoMa">
		<span class="style1">*</span></td>
	</tr>
		<tr>
...
<tr>
	...
	<tr>
		<td><input type="button" name="registrar" value="Registrar usuario" onClick="valida()"></td>
